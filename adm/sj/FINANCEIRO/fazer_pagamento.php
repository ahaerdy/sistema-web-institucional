...
<?php
  $id=getParam('pagamento_id');
  $query = mysql_query("SELECT id,descricao FROM pagamentos WHERE id=".$id);
  $ln = mysql_fetch_assoc($query);
  $descricao_cobranca=$ln['descricao'];
  /*echo "Descrição:".$descricao_cobranca."<br/>";
  exit;*/
    ...
    <div class="well well-lg form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-10"> 
          ...
          elseif (getParam('op2')=="D") 
                  $query = mysql_query('SELECT valor FROM categorias_pagamentos_valores WHERE categoria_pagamento_id = '.$_SESSION['login']['categoria_doacao_id'].' ORDER BY valor ASC'); 
          elseif (getParam('op2')=="N") 
                  $query = mysql_query('SELECT valor FROM categorias_pagamentos_valores WHERE categoria_pagamento_id = '.$_SESSION['login']['categoria_negociacao_id'].' ORDER BY valor ASC');?>                           
      ...
      <div class="form-group buttons" style="display:none;">
        ...
        <div class="col-sm-10">
          ...
          <!-- Removendo o target="blank_", abrindo na mesma aba -->
          <form action="https://www.paypal.com/cgi-bin/webscr" method="post" class="pull-left" style="margin-right: 15px;">
            ...
            <input type="hidden" name="business" value="PAGSEGURO_EMAIL" />
            <input type="hidden" name="return" value="http://www.jessenios.net/adm/index.php" />
            <input type="hidden" name="cancel" value="http://www.jessenios.net/adm/index.php" />
            ...
            <input type="hidden" name="item_name" value="<? echo $descricao_cobranca; ?>">
          ...
          <!-- <form method="post" target="_blank" action="https://sandbox.pagseguro.uol.com.br/v2/checkout/payment.html" class="pull-left"> -->
          <form method="post" action="https://pagseguro.uol.com.br/v2/checkout/payment.html" class="pull-left">
            ...
            <input name="itemDescription1" type="hidden" value="<? echo $descricao_cobranca; ?>">
