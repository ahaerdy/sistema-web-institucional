<?php 
  ...
  header("Content-Disposition: attachment; filename=relatorio_galeiria_videos_".date("Y-m-d-H-i-s").".xls");
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="100"><h1>Relatório de Galeria de Vídeos &nbsp; &nbsp; &nbsp; &nbsp; <?=date("d/m/Y H:i"); ?></h1></td>
  </tr>
  <tr>
    ...
    <th bgcolor="#a2a2a2" >Videos Incoporado</th>
  ...
  <? $query = mysql_query("SELECT 
                          ...
                          FROM
                            ...
                            INNER JOIN galerias_video gl ON tp.id = gl.id_topico");?>
