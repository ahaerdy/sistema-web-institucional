...
<div class="page-header title-article">
  <h2>Mensagens | <small>Mensagens enviadas</small></h2>
</div>
<div class="row">
                ...
                <tr class="link link-message" data-id="<?=$ln['id']; ?>">
                  ...
                  <td nowrap="nowrap">
                    <div class="btn-group">
                      ...
                      <a href="index.php?op=compor_mensagem&mensagem=<?=$ln['id'];?>&encaminhar=1" class="btn btn-primary btn-sm">encaminhar</a>
