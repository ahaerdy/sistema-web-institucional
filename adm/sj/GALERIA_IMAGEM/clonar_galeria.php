<?php
	...
	if(isPost()):
		...
		$res = cloneRegistro($_POST['id'], $_POST['topico'], 'galerias', 'id_topico');
		...
		if($res):
			...
			setFlashMessage('Galeria de foto clonada com sucesso!', 'success');

		else:

			setFlashMessage('A galeria de foto não pode ser clonada!', 'success');
