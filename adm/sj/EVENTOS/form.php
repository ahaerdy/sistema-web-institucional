<div class="well well-lg">
  <form action="#" method="post" id="form" class="form-horizontal" role="form">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <? $params = array('class'=>"form-control required"); $field = 'id_grupo'; $value = $ln['id_grupo'];?>
    ...
    <div class="form-group">
      <label class="col-sm-2 control-label">Chamada:</label>              
      <div class="col-sm-10">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <?=$form->textarea('local', $ln['local'], array('class'=>'required form-control'));?>
      </div>
    </div>
    <div class="form-group">
...
<?php
	...
	$scripts[] = '/adm/sj/js/form_script/event-actions.js';
?>